...
# 注意，这里你要修改path路径。
deny_word = open_dict(Dict='否定词', path=r'data/')
posdict = open_dict(Dict='positive', path=r'data/positive/')
negdict = open_dict(Dict='negative', path=r'data/negative/')

degree_word = open_dict(Dict='程度级别词语', path=r'data/')
...
if __name__ == '__main__':
    ...
    df.to_excel('result2.xlsx', index=None)
